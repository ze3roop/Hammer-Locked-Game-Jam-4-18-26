...
Burst does not guarentee compatibility of results with the .NET implementation.  As a consequence, `HashCode` functions may product different results when running in Burst versus other runtimes environments (ex, Mono).
