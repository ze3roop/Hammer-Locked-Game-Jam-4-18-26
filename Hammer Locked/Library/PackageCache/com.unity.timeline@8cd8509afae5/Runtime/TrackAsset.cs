...
namespace UnityEngine.Timeline
{
    ...
    public abstract partial class TrackAsset : PlayableAsset, IPropertyPreview, ICurvesOwner
    {
        ...
        private static readonly TransientBuildData s_BuildData = TransientBuildData.Create();
        ...
        static readonly TrackAsset[] s_EmptyCache = new TrackAsset[0];
        IEnumerable<TrackAsset> m_ChildTrackCache;

        static readonly Dictionary<Type, TrackBindingTypeAttribute> s_TrackBindingTypeAttributeCache = new Dictionary<Type, TrackBindingTypeAttribute>();
        /// <summary>
