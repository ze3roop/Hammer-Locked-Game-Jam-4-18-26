...
namespace UnityEngine.Timeline
{
    ...
    {
        public const MatchTargetFields All = MatchTargetFields.PositionX | MatchTargetFields.PositionY |
            MatchTargetFields.PositionZ | MatchTargetFields.RotationX |
            MatchTargetFields.RotationY | MatchTargetFields.RotationZ;

        public const MatchTargetFields None = 0;

        public const MatchTargetFields Position = MatchTargetFields.PositionX | MatchTargetFields.PositionY |
            MatchTargetFields.PositionZ;

        public const MatchTargetFields Rotation = MatchTargetFields.RotationX | MatchTargetFields.RotationY |
    ...
    public partial class AnimationTrack : TrackAsset, ILayerable
    {
        ...
        static AnimationClip GetDefaultHumanoidClip()
        {
