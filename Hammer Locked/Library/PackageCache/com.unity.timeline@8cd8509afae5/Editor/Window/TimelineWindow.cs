...
namespace UnityEditor.Timeline
{
    ...
    partial class TimelineWindow : TimelineEditorWindow, IHasCustomMenu, IWindowStateProvider
    {
        ...
        public static bool OnOpenAsset(EntityId instanceId, int line) => OnDoubleClick(instanceId);
#else
        public static bool OnOpenAsset(int instanceId, int line) => OnDoubleClick(instanceId);
#endif

        static bool OnDoubleClick(EntityId instanceID)
        {
